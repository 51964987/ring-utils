...
import ringutils.poi.read.BeanSheetHandlerCallback;
import ringutils.poi.read.ReadSheetContentsHandler;

public class ReadSheetHandlerBeanImpl implements ReadSheetContentsHandler{
	private Logger log = LoggerFactory.getLogger(ReadSheetHandlerBeanImpl.class);
	...
	private BeanSheetHandlerCallback callback;
	
	public ReadSheetHandlerBeanImpl(Class<?> clz, String[] fields, BeanSheetHandlerCallback callback) {
		super();
		this.clz = clz;
		this.fields = fields;
